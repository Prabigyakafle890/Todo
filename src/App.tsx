...
function App() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden px-3 py-4 sm:px-6 sm:py-12">
      ...
      <div className="relative mx-auto w-full max-w-3xl rounded-2xl border border-white/70 bg-white/55 p-4 shadow-[0_20px_70px_rgba(15,23,42,0.15)] backdrop-blur-xl sm:rounded-3xl sm:p-8">
        <Header />
        <DisplayTime />
        <AddTodoForm
          addTodo={addTodo}
